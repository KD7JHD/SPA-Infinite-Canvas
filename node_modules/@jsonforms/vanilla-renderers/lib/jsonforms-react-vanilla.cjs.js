...
var OneOfEnumCell = function (props) {
    var _a;
    var data = props.data, className = props.className, id = props.id, enabled = props.enabled, schema = props.schema, uischema = props.uischema, path = props.path, handleChange = props.handleChange, options = props.options, t = props.t;
    var noneOptionLabel = React.useMemo(function () { return t('enum.none', i18nDefaults['enum.none'], { schema: schema, uischema: uischema, path: path }); }, [t, schema, uischema, path]);
    var noneOption = (React__default["default"].createElement("option", { value: '', key: 'jsonforms.enum.none' }, noneOptionLabel));
    return (React__default["default"].createElement("select", { className: className, id: id, disabled: !enabled, autoFocus: uischema.options && uischema.options.focus, value: data || '', onChange: function (ev) {
            return handleChange(path, ev.target.selectedIndex === 0 ? undefined : ev.target.value);
        } }, (((_a = uischema.options) === null || _a === void 0 ? void 0 : _a.hideEmptyOption) === true ? [] : [noneOption]).concat(options.map(function (optionValue) { return (React__default["default"].createElement("option", { value: optionValue.value, label: optionValue.label, key: optionValue.value })); }))));
};
var oneOfEnumCellTester = core.rankWith(2, core.isOneOfEnumControl);
var OneOfEnumCell$1 = react.withJsonFormsOneOfEnumCellProps(react.withTranslateProps(withVanillaEnumCellProps(OneOfEnumCell)));
...
exports.OneOfEnumCell = OneOfEnumCell$1;
...
exports.oneOfEnumCellTester = oneOfEnumCellTester;
